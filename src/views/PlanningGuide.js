        ...
        <div className="container">
          <div className="row flow-text">
            ...
            <div className="col s12">
              ...
              <p>
                Please know that the our Department has an extensive list of
              ...
              <p>
                ...
                include RCenter in your initial planning meetings. Even one year
                ahead is not too early to contact RCenter to develop marketing
                materials and publicity plans for a major event or campaign.
              </p>
              <p>
              ...
              <p>
                In most cases, there is no charge for our writing, photography,
                and editing services, nor for content creation for Web and
                social media. Hard costs, such as printing, however, must be met
                by the initiating department’s budget. Video recordings of
                campus talks require a set fee to cover SWOP costs. Advertising
                placement costs including TV, radio, print, Web, and social
                media also require funds from the initiating department. A
                RCenter representative will discuss specifics with you after you
              ...
              <p>
                ...
                point, please notify your our contact person. Mark any
                corrections on the proof, and send it back to RCenter as soon as
                possible. The publication will not be sent to print until a
                final sign off is given.
              </p>
              <p>
                See <Link to="glossary">Common RCenter Terms</Link> for more
                information.
              </p>
