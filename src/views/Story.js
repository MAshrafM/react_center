      ...
      <div className="row">
        <div className="col s12 flow-text">
          ...
          <p>
            ...
            fill out the story idea form below, and help us keep a finger on the
            pulse of what’s happening in the classroom, on campus, and in our
            community.
          </p>
          <p>
          ...
          <p>
            Thank you for your help identifying the great work happening in the
            Franciscan University family.
          </p>
        </div>
      </div>
      <div className="row">
